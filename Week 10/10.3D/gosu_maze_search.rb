...
class GameWindow < Gosu::Window
  ...
  def search(cell_x ,cell_y)
   #Checking the cell if it is a part of the maze
    if (@columns[cell_x][cell_y].vacant == false)
      return false
    end

    #Check if the cell have already been visited in the search
    ...
    #Searching the cell to the south
    ...
    #Searching the cell to the west
    if cell_x > 0
    ...
    #Searching the cell to the east
  ...
  def cell_connected(x_cell_count, y_cell_count, columns)
    column_index = 0
  ...
  def update
    cell_connected(@x_cell_count, @y_cell_count, @columns)
  end
