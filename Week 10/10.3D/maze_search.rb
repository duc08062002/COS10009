...
class GameWindow < Gosu::Window
  ...
  def update
    adjacent_cell_condition(@x_cell_count, @y_cell_count, @columns)
    check_if_adjacent_vacant_connected(@x_cell_count, @y_cell_count, @columns)    # For each cell, check if the adjacent cells have been activated/clicked (vacant == true)
  end
